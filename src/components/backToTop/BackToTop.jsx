    ...
    <div className="fixed text-[2.5rem] bottom-10 md:text-[3rem] xl:text-[4rem] -right-4 md:right-0 xl:right-10" >
        {
            ...
            <CiDesktopMouse2 className=" text-[#05AD5D]" />
            <MdOutlineKeyboardArrowUp className="text-[#05AD5D] absolute text-[1.5rem] animate-pulse translate-x-[-50%] top-[40%] md:top-[45%] xl:top-[50%] left-[50%]" />
            </button>:null
        }
    </div>
  )
